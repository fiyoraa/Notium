      ...
      >
        <div className="text-center max-w-md">
          <motion.div
            ...
            className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl shadow-xl mb-6"
          >
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              Press <kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">Ctrl+N</kbd> to create a new note
            </div>
            <div className="flex items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
              Press <kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">Ctrl+K</kbd> to search notes
            </div>
          </div>
        </div>
      </motion.div>
          ...
          <AnimatePresence>
            {tags.map((tag, index) => (
              <motion.span
                ...
                className="group px-3 py-1 bg-gradient-to-r from-indigo-100 to-purple-100 dark:from-indigo-900/30 dark:to-purple-900/30 text-indigo-700 dark:text-indigo-300 rounded-full text-sm flex items-center gap-1"
              >
                #{tag}
                <button
